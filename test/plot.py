...
FILE_PATH = os.path.join(os.path.dirname(__file__), 'TESLAP100.txt')
SAVE_DIR = os.path.join(os.path.dirname(__file__), '../assets')
SAVE_PATH = os.path.join(SAVE_DIR, 'TESLAP100.png')

data  = {'N': [], 'qsort': [], 'V0': [], 'V1': [], 'V2': []}

# read and parse the data from TESLAP100.txt
...
plt.title('NVIDIA Tesla P100 Performance')
plt.grid(True)
plt.legend()
